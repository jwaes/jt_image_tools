...
class ProductProduct(models.Model):
    ...
    def _get_product_variant_landscape_image(self, record):
        ...
        landscapes = record.product_variant_image_ids.filtered(lambda i: i.is_image_landscape)
        if landscapes:
    ...
    def _get_product_variant_portrait_image(self, record):
        ...
        #         return product_image.image_512                
        portraits = record.product_variant_image_ids.filtered(lambda i: i.is_image_portrait)
        if portraits:
    ...
    def _get_square_images(self):
        ...
        return self._get_images().filtered(lambda i: i.is_image_square and i._name == 'product.product')       
